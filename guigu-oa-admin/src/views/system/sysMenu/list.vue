  ...
  <div class="app-container">
    ...
    <div class="tools-div">
      <el-button type="success"
                 ...
                 size="mini"
                 @click="add"
                 :disabled="$hasBP('bnt.sysMenu.add')  === false">添加</el-button>
    </div>
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          ...
          <el-button type="danger"
                     ...
                     title="删除"
                     :disabled="$hasBP('bnt.sysMenu.remove')  === false" />
        </template>
      </el-table-column>
    </el-table>
      ...
      <el-form ref="dataForm"
        ...
        <el-form-item label="菜单类型"
          ...
          <el-radio-group v-model="sysMenu.type"
            ...
            <el-radio :label="0"
                      :disabled="type0Disabled">目录</el-radio>
            <el-radio :label="1"
                      :disabled="type1Disabled">菜单</el-radio>
            <el-radio :label="2"
                      :disabled="type2Disabled">按钮</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item prop="path">
          <span slot="label">
            <el-tooltip content="访问的路由地址，如：`sysUser`"
                        placement="top">

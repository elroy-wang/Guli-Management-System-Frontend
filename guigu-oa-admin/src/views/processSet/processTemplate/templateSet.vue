    ...
    <div v-show="stepIndex == 1"
      ...
      <el-form ref="flashPromotionForm"
        ...
        <el-form-item label="审批类型">
          <el-select v-model="processTemplate.processTypeId"
                     placeholder="请选择审批类型">
            <el-option v-for="item in processTypeList"
                       :label="item.name"
        ...
        <el-form-item label="审批图标">
          <el-select v-model="processTemplate.iconUrl"
                     placeholder="请选择审批图标">
            <el-option v-for="item in iconUrlList"
                       :label="item.iconUrl"
                       :value="item.iconUrl">
    ...
    <div v-show="stepIndex == 3"
      ...
      <el-upload class="upload-demo"
        ...
        <div class="el-upload__tip"
             slot="tip">只能上传zip压缩文件，且不超过2048kb</div>
      </el-upload>
    </div>
  </div>
</template>

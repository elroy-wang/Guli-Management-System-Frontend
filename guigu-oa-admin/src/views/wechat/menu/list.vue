<template>
  <div class="app-container">
    ...
    <div class="tools-div">
      ...
      <el-button class="btn-add"
                 size="mini"
                 @click="syncMenu">同步菜单</el-button>
      <el-button class="btn-add"
                 size="mini"
                 @click="removeMenu">删除菜单</el-button>
    </div>
    ...
    <el-dialog title="添加/修改"
      ...
      <el-form ref="flashPromotionForm"
        ...
        <el-form-item v-if="menu.type == 'view'"
                      label="链接">
          <el-input v-model="menu.url" />
        </el-form-item>
        <el-form-item v-if="menu.type == 'click'"
                      label="菜单KEY">
